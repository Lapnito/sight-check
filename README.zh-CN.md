...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/%E7%A6%BB%E7%BA%BF-%E6%94%AF%E6%8C%81-blueviolet" />
  <img src="https://img.shields.io/badge/%E8%AF%AD%E8%A8%80-20-yellow" />
  <img src="https://img.shields.io/badge/%E5%BC%80%E5%8F%91%E8%80%85-Lapnito-purple" />
</p>
...
> ⚠️ **重要提示：**Sight Check 是一款**纯娱乐性质的游戏**。它**不是医疗器械**，**不能诊断**任何疾病，也**不能替代专业的视力检查**。它无法评估你的视力健康。如果你对自己的视力有任何担忧，请咨询专业眼科医生或验光师。
...
| 场景 | Sight Check 能做什么 |
|------|----------------------|
| 家庭聚餐时争论谁是"鹰眼" | 客厅里轮流传手机比拼，得分画面一锤定音 |
| 有人刚从眼镜店回来，好奇"家里其他人能读到哪一行" | 在家重现经典视力表体验 — 是游戏，不是检查 |
| 聚会需要一个 8 岁到 80 岁都会玩的三分钟破冰游戏 | 规则人人都懂，完全不用解释 |
| "我的新眼镜太棒了" — 需要现场证明 | 读出比上次更小的一行并保存新纪录（纯属娱乐，不是验光复查） |
| 小朋友在家玩"眼科医生"过家家 | 一个安全、诚实的道具，反复提醒大家这只是游戏 |
| 长途车程 / 候诊室无聊时刻 | 完全离线的单人模式：挑战自己的最佳纪录 |

## 核心特色

### 游戏玩法
- **经典视力表玩法** — 字母一行比一行小
- **退后再读** — 视力表本来就该这样玩：隔着整个房间
- **成绩记录** — 每一局都保存在本地
- **个人最佳** — 唯一的对手是上周的自己

### 最原始的多人对战
- **传手机对决** — 朋友、兄弟姐妹、父母、祖辈齐上阵
- **零门槛** — 不用账号、不用房间、不用邀请，把手机递过去就行
...
**怎么开始？**
离屏幕远一点，逐行大声读出字母，然后确认你看到的内容。字母行会越来越小。当小到读不出来时，本局结束，成绩自动保存。

**分数代表什么？**
只是游戏得分 — 表示这一局你在不断缩小的字母表上走了多远。它是用来刷个人纪录、和亲友较量的，**绝不是**任何形式的视力测量。

**这和眼科诊所的视力表一样吗？**
它的外观和仪式感*致敬*了经典视力表，但本质是休闲游戏。真正的视力检查需要标定距离、受控光线、标准视标和专业人员。Sight Check 不具备这些条件，也从不假装具备。

**可以离线玩吗？**
完全可以。飞行模式、深山小屋、地下车库 — 游戏毫不在意。

**我的成绩会传到哪里？**
哪儿也不去。只保存在你的设备上。没有云端、没有账号、没有数据分析。
...
**Sight Check 是真正的视力检查吗？**
不是。Sight Check 只是一款娱乐游戏。它不诊断任何疾病、不测量视力，也不能替代专业视力检查。如果你担心自己的视力，请去看验光师或眼科医生。

**Sight Check 免费吗？**
是的 — 完全免费，永久免费。无广告、无内购、无订阅。

**需要注册账号吗？**
不需要。无账号、无注册、无邮箱。装上就能玩。

**可以离线使用吗？**
可以，完全离线。它从不需要联网。

**我的成绩存在哪里？**
只存在你的设备上。除非你主动把屏幕给别人看，否则任何内容都不会被上传、追踪或分享。

**孩子可以玩吗？**
可以 — 这是一款简单的认字母游戏，无广告、无聊天、不收集数据。（而且它会反复提醒所有人：这不是医学检查。）
...
**Lapnito Development Studio**（lapnito.cz s.r.o.，捷克）专注打造小巧、诚实、隐私优先的工具与游戏：无广告、无账号、不收集数据。

- **支持：**[github.com/Lapnito/sight-check/issues](https://github.com/Lapnito/sight-check/issues)
- **邮箱：**tom@lapnito.cz
- **更多应用：**[App Store 开发者主页](https://apps.apple.com/us/developer/id1577358577) · [Google Play 开发者主页](https://play.google.com/store/apps/dev?id=8923575656207320763)
...
<script type="application/ld+json">
{
  ...
  "inLanguage": "zh-CN",
  "description": "Sight Check: Eye Chart Game 是一款免费休闲游戏，灵感来自验光师诊室里经典的视力字母表。站远一点，大声朗读一行行越来越小的字母，保存成绩并不断刷新个人纪录。把手机递给家人和朋友，看看谁能在房间另一头读出最小的那一行。永久免费，无广告、无内购、无需账号，完全离线运行——所有成绩都只留在设备上。仅供娱乐：本应用不是医疗器械，也不能替代专业眼科检查。",
...
<p align="center">由 <b>lapnito.cz s.r.o.</b> 在捷克用 ❤️ 打造</p>
