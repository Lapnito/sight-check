...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Offline-Ya-blueviolet" />
  <img src="https://img.shields.io/badge/Bahasa-20-yellow" />
  <img src="https://img.shields.io/badge/Pengembang-Lapnito-purple" />
</p>
...
> ⚠️ **Penting:** Sight Check adalah **game yang dibuat murni untuk hiburan**. Aplikasi ini **bukan** alat kesehatan, **tidak** mendiagnosis kondisi apa pun, dan **bukan** pengganti pemeriksaan mata profesional. Aplikasi ini tidak dapat mengukur kesehatan penglihatanmu. Jika kamu punya keluhan tentang penglihatan, konsultasikan dengan dokter mata atau optometris.
...
| Momen | Peran Sight Check |
|-------|-------------------|
| Debat di meja makan soal siapa yang punya "mata elang" di keluarga | Duel oper-HP dari seberang ruang tamu; layar skor jadi jurinya |
| Baru pulang dari optik dan penasaran "kalau anggota keluarga lain gimana ya?" | Pengalaman papan huruf klasik di rumah — sebagai game, bukan pemeriksaan |
| Acara kumpul butuh pemecah suasana 3 menit yang cocok untuk umur 8 sampai 80 | Semua orang sudah tahu aturannya; tak perlu penjelasan |
| Momen "kacamata baruku mantap banget" — buktikan! | Baca baris yang lebih kecil dari sebelumnya dan simpan rekor baru (untuk seru-seruan, bukan cek resep kacamata) |
| Anak-anak main "dokter-dokteran mata" di rumah | Properti main yang aman dan jujur — terus mengingatkan bahwa ini cuma game |
| Perjalanan jauh / bosan di ruang tunggu | Mode single-player sepenuhnya offline: kalahkan rekormu sendiri |

## Fitur Utama

### Gameplay
- **Gaya papan huruf klasik** — deretan huruf yang makin mengecil seiring permainan
- **Mundur lalu baca** — dimainkan persis seperti papan huruf optik seharusnya dinikmati: dari seberang ruangan
- **Pencatatan skor** — setiap ronde tersimpan secara lokal
- **Rekor pribadi** — satu-satunya lawan yang penting adalah dirimu minggu lalu

### Multiplayer Cara Analog
- **Duel oper-HP** — teman, saudara, orang tua, kakek-nenek
- **Bandingkan hasil buat lucu-lucuan** — rivalitas ketajaman mata antargenerasi, akhirnya ada angkanya
- **Tanpa persiapan** — tanpa akun, tanpa lobby, tanpa undangan; tinggal oper HP-nya

### Privasi Sejak Dirancang
- **Gratis selamanya** — tanpa iklan, tanpa pembelian dalam aplikasi, tanpa "premium"
- **Tanpa akun, tanpa daftar, tanpa email**
- **Sepenuhnya offline** — jalan di mode pesawat
- **Hasil tersimpan di perangkatmu** — tidak ada pelacakan, tidak ada unggahan

## Cara Kerja Sight Check

**Bagaimana cara mainnya?**
Mundur dari layar, baca tiap baris huruf dengan suara keras, lalu konfirmasi apa yang kamu lihat. Barisnya makin mengecil. Saat hurufnya sudah terlalu kecil untuk dibaca, ronde berakhir dan skormu tersimpan.

**Apa arti skornya?**
Itu skor game — seberapa jauh kamu turun di papan huruf yang mengecil pada ronde itu. Dirancang untuk rekor pribadi dan adu seru dengan teman, **bukan** sebagai pengukuran penglihatan dalam bentuk apa pun.

**Ini sama dengan papan huruf di optik?**
...
**Apakah Sight Check tes mata sungguhan?**
Bukan. Sight Check adalah game untuk hiburan semata. Aplikasi ini tidak mendiagnosis kondisi apa pun, tidak mengukur penglihatanmu, dan bukan pengganti pemeriksaan mata profesional. Jika kamu punya keluhan tentang penglihatan, periksakan ke dokter mata atau optometris.

**Apakah Sight Check gratis?**
Ya — sepenuhnya gratis, selamanya. Tanpa iklan, tanpa pembelian dalam aplikasi, tanpa langganan, tanpa fitur premium berbayar.

**Perlu bikin akun?**
Tidak. Tanpa akun, tanpa daftar, tanpa email. Pasang dan langsung main.

**Bisa dipakai offline?**
Ya, sepenuhnya. Tidak pernah butuh koneksi internet.

**Di mana hasilku disimpan?**
Hanya di perangkatmu. Tidak ada yang diunggah, dilacak, atau dibagikan — kecuali kamu sendiri yang menunjukkan layarmu ke orang lain.

**Aman untuk anak-anak?**
Ya — ini game baca huruf sederhana tanpa iklan, tanpa chat, dan tanpa pengumpulan data. (Dan aplikasinya terus mengingatkan semua orang bahwa ini bukan tes medis.)

**Harus berdiri seberapa jauh dari layar?**
...
**Lapnito Development Studio** (lapnito.cz s.r.o., Republik Ceko) membuat utilitas dan game kecil yang jujur dan mengutamakan privasi: tanpa iklan, tanpa akun, tanpa pengumpulan data.

- **Dukungan:** [github.com/Lapnito/sight-check/issues](https://github.com/Lapnito/sight-check/issues)
- **Email:** tom@lapnito.cz
- **Aplikasi lainnya:** [Halaman pengembang App Store](https://apps.apple.com/us/developer/id1588955203) · [Halaman pengembang Google Play](https://play.google.com/store/apps/dev?id=8923575656207320763)
